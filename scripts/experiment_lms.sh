...
do
    ...
    do
        # RNN LM
        SAVE_DIR="work/results/${LANG}/${FOLD}/fairseq/rnn"
        mkdir -p "${SAVE_DIR}"
        ...
        # LSTM LM
        SAVE_DIR="work/results/${LANG}/${FOLD}/fairseq/lstm"
        mkdir -p "${SAVE_DIR}"
        ...
        # Transformer LM
        SAVE_DIR="work/results/${LANG}/${FOLD}/fairseq/trans"
        mkdir -p "${SAVE_DIR}"
        ...
        do
            # RNN PLM
            SAVE_DIR="work/results/${LANG}/${FOLD}/${TRAVERSAL}/fairseq/rnn"
            ...
            # LSTM PLM
            SAVE_DIR="work/results/${LANG}/${FOLD}/${TRAVERSAL}/fairseq/lstm"
            ...
            # Transformer PLM
            SAVE_DIR="work/results/${LANG}/${FOLD}/${TRAVERSAL}/fairseq/trans"
