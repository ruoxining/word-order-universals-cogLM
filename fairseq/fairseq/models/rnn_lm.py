...
from fairseq.models.rnn import Embedding, RNNDecoder
...
class RNNLanguageModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--residuals', default=False,
                            action='store_true',
                            help='applying residuals between RNN layers')
...
@register_model_architecture("rnn_lm", "rnn_lm")
...
@register_model_architecture("rnn_lm", "rnn_small_lm")
def rnn_small(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 64)
    args.decoder_hidden_size = getattr(
        args, "decoder_hidden_size", 64
    )
